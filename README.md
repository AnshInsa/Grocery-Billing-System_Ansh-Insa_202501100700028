...
-Step 1: Take Input
         Accept the price of 3 items from the user.
         Use float() because prices can contain decimal values.

-Step 2: Calculate Original Total
         Add the three item prices.

-Step 3: Initialize Discount
         Set discount to 0 initially

-Step 4: Apply Condition (Decision Making)
...
Sample Output:         
Enter price of item 2: $70
Enter price of item 3: $21

----- Bill Details -----
Original Total: $ 171.0
Discount: $ 17.1
Final Amount: $ 153.9
